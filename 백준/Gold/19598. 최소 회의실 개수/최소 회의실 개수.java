...
public class Main {
    ...
    private static void setAdd(TreeSet<Integer> rooms, Map<Integer, Integer> counts, Integer val) {
        rooms.add(val);
    ...
    private static void setSub(TreeSet<Integer> rooms, Map<Integer, Integer> counts, Integer val) {
        counts.put(val, counts.get(val) - 1);
        if (counts.get(val) == 0) {
            counts.remove(val);
            rooms.remove(val);
